...
enum BucketType { recommended, popularInMajor, popularOnCampus, exploreMore, otherAreas }
  ...
  Widget build(BuildContext context) {
    ...
    final (label, microcopy, color) = switch (type) {
      ...
      BucketType.popularInMajor => (
          ...
          areaLabel != null ? 'Elegido por estudiantes de $areaLabel' : 'Popular entre estudiantes similares',
          cs.tertiary,
        ),

...
class AppTextStyles {
  ...
  static TextStyle headlineLg(Color color) => _headlineLg.copyWith(color: color);
  static TextStyle headlineMd(Color color) => _headlineMd.copyWith(color: color);
  static TextStyle headlineSm(Color color) => _headlineSm.copyWith(color: color);
